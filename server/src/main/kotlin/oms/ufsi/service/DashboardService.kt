...
data class DashboardData(val projectsTotal:Long,val projectsActive:Long,val budgetPlanned:Long,val amountSpent:Long,val inspectionsTotal:Long,val findingsTotal:Long,val recentInspections:List<InspectionReport>,val activities:List<ActivityEntry>)
