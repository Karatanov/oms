...
fun Route.dashboardRoutes() {
    get("/api/v1/dashboard") {
        ...
        call.respond(DashboardResponse(d.projectsTotal, d.projectsActive, d.projectsCompletedThisMonth, d.budgetPlanned, d.amountSpent, d.inspectionsTotal, d.pendingInspections, d.findingsTotal, d.recentInspections.map { it.toResponse() }, d.activities.map { ActivityResponse(it.action, it.entityType, it.entityId, it.userLogin, it.createdAt.toString()) }))
    }
}
