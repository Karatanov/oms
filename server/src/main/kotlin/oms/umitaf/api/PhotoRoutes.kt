...
fun Route.photoRoutes() = route("/api/v1/inspection-reports/{reportUuid}/photos") {
    ...
    post {
        ...
        val uploaded = mutableListOf<oms.umitaf.domain.InspectionPhoto>()
        try {
 ...
 */
internal fun hydrateEmbeddedSirPhotos(report: InspectionReport): List<oms.umitaf.domain.InspectionPhoto> {
