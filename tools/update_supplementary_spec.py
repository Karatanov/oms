...
sections = {
    "13.1 Implemented Phase 1 modules": [
        ...
        "Document management supports file-system storage, typed upload, filtering, original-filename download and role-controlled permanent deletion. Document filter tabs are All, Contract, Project / Subproject, Design, Estimate, Financial Doc (invoice or act), Photo and Other; document types are rendered as colour badges.",
