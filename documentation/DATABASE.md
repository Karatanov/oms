...
OMS uses MySQL 8 and Flyway. The canonical source is `server/src/main/resources/db/migration`; Exposed table mappings mirror the current schema. Migrations V1-V33 run automatically at startup in version order.
...
- Empty database: create the database/user, start OMS, and wait for Flyway V1-V33 plus `/health`.
